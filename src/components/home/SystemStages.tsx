...
export function SystemStages() {
  ...
  return (
    <Section spacing="loose" ruled aria-labelledby="stages-title">
      ...
      <Reveal as="ol" className="mt-14 flex items-center gap-3" aria-label="Five-stage system">
      ...
      <Reveal as="div" stagger className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
